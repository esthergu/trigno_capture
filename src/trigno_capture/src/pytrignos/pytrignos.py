...
class TrignoEMG(_BaseTrignoDaq):
    ...
    def __init__(self, sensors_numbers, units='V',
                 host='192.168.125.1', cmd_port=50040, data_port=50043, timeout=10):
...
class TrignoOrientation(_BaseTrignoDaq):
    ...
    timeout : float, optional
        Number of seconds before socket returns a timeout exception.
    """
    def __init__(self, sensors_numbers, host='192.168.125.1',
...
class TrignoAdapter():
    ...
    def sensors_reading(self, sensors_labels = '', buffered = False):
        """
